...
X = df[['Gender', 'Age','Cefepime','Cotrimoxazole','Amikacin']]
Y = df['Aztreonam']
...
def pred(det1, det2, det3, det4, det5):
    return clf_gini.predict([[det1, det2, det3, det4, det5]])

#result = pred(0, 45, 0, 0, 0)
#print ("\n\n\n",result[0])
